                                  ...
                                  else
                                  {
                                    try{
                                        ...
                                        let newPassword = await axios.put(`http://localhost:3001/api/profile/${userid}`,{
                                            ...
                                            'userId':+userid+'',
                                            'password':''+hash,
                                          'oldPassword': old.data+''},{ headers: { Authorization: 'Bearer ' + tokenData.authData }})
                ...
                let userid =tokenData.userData.userId;
                  ...
                  try{
                      let newprof = await axios.put(`http://localhost:3001/api/profile/${userid}`,{
                          'userType':'Partner',
                          'userId':userid+'',
                          'boardMembers':this.state.boardMembers},{ headers: { Authorization: 'Bearer ' + tokenData.authData }})
